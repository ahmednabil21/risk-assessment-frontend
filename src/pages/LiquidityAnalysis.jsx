...
export default function LiquidityAnalysis() {
  ...
  const handleUpload = async () => {
    ...
    formData.append("type", "liquidity_risk");
    ...
    try {
      ...
      localStorage.setItem("liquidity_results", JSON.stringify(res.data));
    } catch (err) {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-4">تحليل مخاطر السيولة</h2>
