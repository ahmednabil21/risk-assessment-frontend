...
export default function OperationalAnalysis() {
  ...
  const handleUpload = async () => {
    ...
    formData.append("type", "operational_risk");
    ...
    try {
      ...
      localStorage.setItem("operational_results", JSON.stringify(res.data));
    } catch (err) {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-4">تحليل المخاطر التشغيلية</h2>
